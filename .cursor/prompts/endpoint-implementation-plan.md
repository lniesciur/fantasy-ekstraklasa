...
{{PASTE_ENDPOINT_SPEC_HERE}}
</route_api_specification>

2. Related database resources:
<related_db_resources>
@db-plan.md #{{related-tables}}
</related_db_resources>
...
Remember to save your implementation plan as .ai/implementation_plans/{endpoint_name}.md. Ensure the plan is detailed, clear, and provides comprehensive guidance for the development team.